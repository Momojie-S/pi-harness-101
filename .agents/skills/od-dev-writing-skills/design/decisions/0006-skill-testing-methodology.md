...
本项目**多数 skill 是方法论覆盖型 / how-to / reference**(gameplay-automation / screen-onboarding / od-dev-ui-region-detect / deciding-a-fix / debug-automation),要测的是"**能不能照方法论把活干好**",不是"守不守纪律"。pressure test 不对症。
